...
public class SingletonTest {
    ...
    private static final SingletonTest dbConnection = new SingletonTest();
    ...
    public static void main(String[] args) {
        ...
        final SingletonTest instance = SingletonTest.getInstance();
 ...
 */
class DBConnectionLazy1 {

    // Lazily initialized singleton instance.
    private static DBConnectionLazy1 dbConnection;

    // Private constructor to prevent instantiation.
    private DBConnectionLazy1() {
    }
     ...
     * @return the singleton instance.
     */
    public static DBConnectionLazy1 getInstance() {
        if (dbConnection == null) {
            dbConnection = new DBConnectionLazy1();
        }
        return dbConnection;
    }
